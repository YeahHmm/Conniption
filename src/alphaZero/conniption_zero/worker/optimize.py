...
from conniption_zero.agent.model_connect4 import Connect4Model, objective_function_for_policy, \
...
def start(config: Config):
    tf_util.set_session_config(per_process_gpu_memory_fraction=0.55)
